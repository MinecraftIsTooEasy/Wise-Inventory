...
//        swapHotBar(slot, 0);
    ...
    public static void addToSpreading(Slot slot, boolean rightClick) {
        clickSlot(slot, Container.func_94534_d(1, rightClick ? 1 : 0), SlotActionType.QUICK_CRAFT);
    }

    public static void finishSpreading(boolean rightClick) {
        clickSlot(-999, Container.func_94534_d(2, rightClick ? 1 : 0), SlotActionType.QUICK_CRAFT);
    }
